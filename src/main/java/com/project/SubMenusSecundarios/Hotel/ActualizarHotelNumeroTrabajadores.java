 ...
 * @author aspxe
 */
public class ActualizarHotelNumeroTrabajadores extends javax.swing.JFrame {

    /**
     * Creates new form ActualizarHotelNumeroTrabajadores
     */
    public ActualizarHotelNumeroTrabajadores() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Actualizar numero de trabajadores");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(42, 42, 42)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lblNumeroTrabajadores)
                            .addComponent(lblIdHotel)
                            .addComponent(txtIdHotel, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtNumeroTrabajadores, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(153, 153, 153)
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        int idHotel = 0, numeroTrabajadores = 0;
        ...
        try {
            hd.actualizarNumeroTrabajadores(h);
            JOptionPane.showMessageDialog(rootPane, "Numero de trabajadores actualizado exitosamente", "Registro actualizado", JOptionPane.INFORMATION_MESSAGE);
        } catch (SQLException ex) {
            Logger.getLogger(ActualizarHotelNumeroTrabajadores.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActualizarHotelNumeroTrabajadores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ActualizarHotelNumeroTrabajadores().setVisible(true);
            }
        });
    }
